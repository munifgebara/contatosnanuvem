...
public class ControladorPrincipal extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if ("autocadastro".equals(ac)) {
                String pin = Negociao.autoCadastro(request.getParameter("email"));
                request.setAttribute("novoPin", pin);
            ...
            request.getRequestDispatcher("problemas.jsp").forward(request, response);
        }
